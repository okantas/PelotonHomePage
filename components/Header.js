...
export default function Header() {
  ...
  return (
    ...
    flex flex-col lg:flex-row lg:max-h-full lg:opacity-100 lg:scale-y-100 justify-center w-full mt-2 lg:mt-0 items-end gap-y-2 gap-x-9 font-bold text-white text-sm tracking-widest`}
      >
